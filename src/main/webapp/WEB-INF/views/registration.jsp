			...
			<div class="row">
				...
				<div class="col-lg-12 form_col">
					<div class="contact_form_container">
						<form:form id="contact_form" class="contact_form" modelAttribute="registration" action="saveNGO" method="post">
							<div class="row">
								<div class="col-md-6 input_col">
									<div class="input_container input_name"><form:input path="NGOName" type="text" class="contact_input" placeholder="Name" required="required"/></div>
								</div>
								<div class="col-md-6 input_col">
							...
							<div class="row">
							   <div class="col-md-1 input_col">
									<div class="input_container input_name">Services:</div>
								</div>
								
								<div class="col-md-2 input_col">
									<div class="input_container input_name"><form:checkbox path="Service1" value="medicine"/> Medicine</div>
								</div>
								<div class="col-md-2 input_col">
									<div class="input_container"><div class="input_container input_name"><form:checkbox path="Service3" value="clothes"/> Cloth</div></div>
								</div>
								<div class="col-md-2 input_col">
									<div class="input_container"><div class="input_container input_name"><form:checkbox path="Service2" value="food" /> Food</div></div>
								</div>
							</div>
							<div class="input_container"><form:input path="CAPACITY" type="text" class="contact_input" placeholder="Capacity" required="required"/></div>
							...
							<button class="button contact_button"><a href="#">Register</a></button>							
						</form:form>
					</div>
				</div>
			</div>
